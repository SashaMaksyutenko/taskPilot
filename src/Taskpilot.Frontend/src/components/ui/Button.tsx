...
const variants: Record<Variant, string> = {
  primary:
    'gradient-primary text-white shadow-sm shadow-primary/25 transition hover:shadow-md hover:shadow-primary/30 hover:brightness-[1.06] focus-visible:ring-primary/40',
  secondary:
