...
import { fetchMe, linkedinLogin } from '../store/authSlice'
import { useAppDispatch } from '../store/hooks'
import { notify } from '../lib/toast'

/**
 * Landing route for LinkedIn's OAuth redirect. Reads the "?code=" LinkedIn appends,
  ...
  useEffect(() => {
    ...
    dispatch(linkedinLogin(code))
      ...
      .catch((message: string) => {
        notify.error(message || t('auth.linkedinFailed'))
        navigate('/login', { replace: true })
      })
