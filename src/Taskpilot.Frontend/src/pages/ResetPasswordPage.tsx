  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-canvas px-6">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-8 shadow-sm">
        ...
        {!token ? (
          <>
            <p className="mt-3 text-sm text-muted">{t('reset.noToken')}</p>
          ...
          <form onSubmit={submit} className="mt-6 space-y-4" noValidate>
            <div>
              <label className="mb-1 block text-sm font-medium text-foreground">{t('reset.newPassword')}</label>
              <input
                type="password"
                value={password}
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-foreground">{t('reset.confirm')}</label>
              <input
                type="password"
                value={confirm}
