...
public class TaskServiceTests
{
    ...
    private static (TaskService svc, Mock<INotificationService> notifications) CreateWithMock(TaskpilotDbContext ctx)
    {
        ...
        var svc = new TaskService(ctx, new Mock<IWebhookService>().Object, notifications.Object, new Mock<IReputationService>().Object, new Mock<IAuditService>().Object, new Mock<ITaskAttachmentService>().Object, NullLogger<TaskService>.Instance);
